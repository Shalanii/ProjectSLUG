...
<html lang="en">
  ...
  <body>
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html"><img src="/img/slug.png" class="img-responsive2" width="100px" height="60px"><span>SLUG-2019</span></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active">
                    <a class="nav-link" href="/NewHome">Home</a>
                </li>
	          ...
	          <li class="nav-item ">
                    <a class="nav-link" href="/Schedule1">Schedule</a>
                </li>
                <li class="nav-item ">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/Streams">Streams Games</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#"role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Games
