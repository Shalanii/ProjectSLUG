...
<div class="container">
  <center><h3>Tennis Result Add</h3></center>
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="/saveTennisResult" class="form-horizontal">
                    {{ csrf_field() }}
                    <div class="col-md-12">
                        @if(isset($error))
...
<div class="container">
<center><h3>Tennis Result View</h3></center>
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
      <table class="table table-hover table-responsive">
          ...
          <tr>
              ...
              <td>{{$task->Winner}}</td>
              <td>
                  <a href="/deleteTennisResult/{{$task->MatchNo}}/{{$task->Gender}}" class="btn btn-danger btn-sm">Delete</a></td>  
          </tr>
          @endforeach
          @endif
      </table>
