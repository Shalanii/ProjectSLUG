...
@section('content')
<center><h3>FootBall Result Add</h3></center>
<div class="x"> 
<div class="container">
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
      <?php //form Validation ?>
        <form action="/saveFootballResult" method="post">
          {{csrf_field()}}
          <div class="col-md-12">
            @if(isset($error))
    ...
    <div class="card">
      ...
      <table class="table table-hover table-responsive">
          ...
          <tr><td>{{$task->Date}}</td>
              ...
              <td>{{$task->Winner}}</td>
              <td><a href="/deleteFootballResult/{{$task->MatchNo}}" class="btn btn-danger btn-sm">Delete</a></td>   
          </tr>
          @endforeach
          @endif
      </table>
