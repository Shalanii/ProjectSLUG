@extends('welcome')
@section('content')
<center><h3>Jumping Result Add</h3></center>
<div class="x"> 
<div class="container">
  <div class="col-sm-12">
    <div class="card">
      ...
      <?php //form Validation ?>
        ...
        @endif
        <form action="/saveJumpingResult" method="post">
          {{csrf_field()}}
          <div class="row">
            <div class="col-md-3">
    ...
    <div class="card">
      ...
      <table class="table table-hover table-responsive">
          ...
          <tr>
              ...
              <td>{{$task->Height_Distance}}</td>
              <td>{{$task->Rank}}</td>
              <td>
                  <a href="/deleteJumpingResult/{{$task->Gender}}/{{$task->Event}}/{{$task->MatchNo}}/{{$task->Uni}}/{{$task->PlayerName}}" class="btn btn-danger btn-sm">Delete</a></td>   
          </tr>
          @endforeach
