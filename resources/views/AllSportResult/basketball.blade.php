...
@section('content')
<center><h3>BasketBall Result Add</h3></center>
<div class="x"> 
<div class="container">
  <div class="col-sm-12">
    <div class="card">
      ...
      <?php //form Validation ?>
        ...
        <form action="/saveBasketballResult" method="post">
          {{csrf_field()}}
          <div class="col-md-12">
              @if(isset($error))
          ...
          <div class="col-md-3">
            ...
            <div class="col-md-3">
              <label>Round</label>
              <div class="form-group{{ $errors->has('Round') ? ' has-error' : '' }}">
		          <select name="Round" class="form-control" placeholder="Round">
                  <option></option>
          ...
          <div class="col-md-3">
              ...
              <div class="form-group{{ $errors->has('SportGroup') ? ' has-error' : '' }}">
                <select name="SportGroup" class="form-control" placeholder="SportGroup">
                  <option></option>
                  <option>A</option>
			            <option>B</option>
			            <option>C</option>
            ...
            <div class="col-md-3">
                <label>Uni 1</label>
                <div class="form-group{{ $errors->has('SportGroup') ? ' has-error' : '' }}">
                <select name="Uni1" class="form-control" placeholder="UniId1">
                    <option></option>
            ...
            <div class="col-md-3">
              ...
              <div class="form-group{{ $errors->has('Uni1_Score') ? ' has-error' : '' }}">
		          <input type="number" name="Uni1_Score" class="form-control input-sm" placeholder="Uni1 Score">  
           ...
           <div class="col-md-3">
              ...
              <div class="form-group{{ $errors->has('Uni2') ? ' has-error' : '' }}">
                <select name="Uni2" class="form-control" placeholder="Uni2ID">
                    <option></option>
                    @foreach($uniIDarray as $data)
                    <option value="{{$data->UniID}}">{{$data->UniID}}</option>
                    @endforeach
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <label>Uni2 Score</label>
		            <input type="number" name="Uni2_Score" class="form-control input-sm" placeholder="Uni2 Score">
      ...
      <table class="table table-hover table-responsive table-bordered">
          ...
          <tr>
              ...
              <td>{{$task->Uni2_Score}}</td>  
	            <td>{{$task->Winner}}</td>
              <td>{{$task->Gender}}</td>
              <td><a href="/deleteBasketballResult/{{$task->MatchNo}}/{{$task->Gender}}" class="btn btn-danger btn-sm">Delete</a></td>   
          </tr>
          @endforeach
          @endif
      </table>
