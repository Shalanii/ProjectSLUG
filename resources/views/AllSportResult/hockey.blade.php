...
@section('content')
<center><h3>Hockey Result Add</h3></center>
...
<div class="container">
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
      <?php //form Validation ?>
        <form action="/saveHockeyResult" method="post">
          {{csrf_field()}}
          <div class="col-md-12">
            @if(isset($error))
    ...
    <div class="card">
      ...
      <table class="table table-hover table-responsive " align="center">
          ...
          <tr>
              ...
              <td>{{$task->Gender}}</td>
              <td>
                  <a href="/deleteHockeyResult/{{$task->MatchNo}}/{{$task->Gender}}" class="btn btn-danger btn-sm">Delete</a></td>   
          </tr>
          @endforeach
          @endif
      </table>
