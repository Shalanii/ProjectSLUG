...
<div class="container">
  <center><h3>Carrom Result Add</h3></center>
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="/saveCarromResult" class="form-horizontal">
                    {{ csrf_field() }}
                    <div class="col-md-12">
                        @if(isset($error))
                    ...
                    <div class="row">
                        ...
                        <label>University 1 - Wins</label>
                            <div class="form-group{{ $errors->has('uni1_wins') ? ' has-error' : '' }}">
                                ...
                                <input type="number" name="uni1_wins" class="form-control">
                        ...
                        <label>University 2 - Wins</label>
                            <div class="form-group{{ $errors->has('uni2_wins') ? ' has-error' : '' }}">       
                                <input type="number" name="uni2_wins" class="form-control">
...
<div class="container">
<center><h3>Carrom Result View</h3></center>
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
      <table class="table table-hover table-responsive">
          ...
          <tr>
              ...
              <td>{{$task->Winner}}</td>
              <td><a href="/deleteCarromResult/{{$task->MatchNo}}/{{$task->Gender}}" class="btn btn-danger btn-sm">Delete</a></td>  
          </tr>
          @endforeach
          @endif
      </table>
