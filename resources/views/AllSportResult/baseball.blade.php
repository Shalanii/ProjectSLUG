@extends('welcome')
@section('content')
<center><h3>Baseball Result Add</h3></center>
<div class="x"> 
<div class="container">
  <div class="col-sm-12">
    <div class="card">
      ...
      <?php //form Validation ?>
        ...
        <form action="/saveBaseballResult" method="post">
          {{csrf_field()}}
          <div class="col-md-12">
                    @if(isset($error))
            ...
            <div class="col-md-3">
              <div class="form-group{{ $errors->has('MatchNo') ? ' has-error' : '' }}">
                <label>Match No</label>
                  <input type="text" name="MatchNo"  class="form-control input-sm" placeholder="Match No" required autofocus> 
          ...
          <div class="col-md-3">
              <div class="form-group{{ $errors->has('Round') ? ' has-error' : '' }}">
                <label>SportGroup</label>
                  <select name="SportGroup" class="browser-default custom-select" class="form-control" required autofocus>
                    <option></option>
                    <option>A</option>
			              <option>B</option>
			              <option>C</option>
    ...
    <div class="card">
      ...
      <table class="table table-hover table-responsive">
          ...
          <tr>
              ...
              <td>{{$task->Winner}}</td>
              <td><a href="/deleteBaseballResult/{{$task->MatchNo}}" class="btn btn-danger btn-sm">Delete</a></td>   
          </tr>
          @endforeach
          @endif
      </table>
