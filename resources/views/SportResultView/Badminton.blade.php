...
<div class="container">
	<div class="jumbotron" style="background: linear-gradient(to bottom left, #00ccff 23%, #cc33ff 100%);">
        <div class="heading-section ftco-animate">
	            ...
	            <h2 class="text-center">Badminton Game Reports</h2>
	    </div>
        <div class="d-flex justify-content-center">
            <form class="form-inline" action="/search1" method="post">
                {{csrf_field()}}
    ...
    <div class="container" align="center">
        ...
        @foreach($r as $item)
        <div class="col-md-6">
            <div class="scoreboard scoreboard-2 slash" style="background:url(/img/mascot/bb.jpg);background-size:cover;min-height:auto;" data-stellar-background-ratio="0.5">
            <br>
			<div class="divider ftco-animate text-center"><span style="color:#dae44d;font-size:16px;">{{$item->Date}}  Round - {{$item->Round}}</span></div>
				<div class="divider ftco-animate text-center mb-4"><span class="x">{{$item->Gender}}</span></div>
			        ...
			        <div class="text-center ftco-animate">
                        ...
                        @endif
				          	<p class="mb-0"><a href="badmintonresult/{{$item->MatchNo}}" class="btn btn-black">More Details</a></p>
				    </div>
			    </div>
	          	</div>
    @endforeach
