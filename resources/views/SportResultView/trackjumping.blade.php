...
<div class="row justify-content-md-center">
    ...
    <div class="scoreboard scoreboard-2 slash">
        <h4 style="font-size:20px;"><center>High Jump(Men)</center></h4>
    ...
    <div class="col-md-6">
    <div class="scoreboard scoreboard-2 slash">
        <h4 style="font-size:20px;"><center>High Jump(Women)</center></h4>
        <h4 style="font-size:20px;"><center>Final Result</center></h4>
        <hr class="my-8">
            <div class="table-responsive">
            <table class="table table-hover table-dark">
...
<div class="col-md-6">
<div class="scoreboard scoreboard-2 slash">
        <h4 style="color:black;font-size:20px;"><center>Long Jump(Men)</center></h4>
    ...
    <div class="col-md-6">
    <div class="scoreboard scoreboard-2 slash">
        <h4 style="color:black;font-size:20px;"><center>Long Jump(Women)</center></h4>
        <h4 style="color:black;font-size:20px;"><center>Final Result</center></h4>
        <hr class="my-8">
            <div class="table-responsive">
            <table class="table table-hover table-dark">
...
<div class="col-md-6">
<div class="scoreboard scoreboard-2 slash">
        <h4 style="color:black;font-size:20px;"><center>Triple Jump(Men)</center></h4>
        <h4 style="color:black;font-size:20px;"><center>Final Result</center></h4>
        <hr class="my-8">
            <div class="table-responsive">
            <table class="table table-hover table-dark">
    ...
    <div class="col-md-6">
    <div class="scoreboard scoreboard-2 slash">
        <h4 style="color:black;font-size:20px;"><center>Triple Jump(Women)</center></h4>
        <h4 style="color:black;font-size:20px;"><center>Final Result</center></h4>
            <hr class="my-8">
            <div class="table-responsive">
            <table class="table table-hover table-dark">
...
<div class="row">
    <div class="col-md-6">
    <div class="scoreboard scoreboard-2 slash">
        <h4 style="color:black;font-size:20px;"><center>Pole Vault(Men)</center></h4>
        <h4 style="color:black;font-size:20px;"><center>Final Result</center></h4>
        <hr class="my-8">
            <div class="table-responsive">
            <table class="table table-hover table-dark">
