...
<section class="blog"><br><br>
	...
	<div class="jumbotron" style="background: linear-gradient(to bottom left, #00ccff 23%, #cc33ff 100%);">
        <div class="heading-section ftco-animate">
	        <h2 class="mb-4 text-center">Football Game Reports</h2>
	    </div>
        <div class="d-flex justify-content-center">
        <form class="form-inline" action="/search4" method="post">
        {{csrf_field()}}
...
<div class="container" align="center">
    ...
    @foreach($r as $item)
    <div class="col-md-6">
	    <div class="scoreboard scoreboard-2 slash" style="background:url(/img/image/foot.jpg);background-size:cover;min-height:auto;" data-stellar-background-ratio="0.5">
			...
			@elseif(($item->Description!=''))
			                <h6 style="color:#cc9b17;font-size:17px;">{{$item->Description}}</h6>
