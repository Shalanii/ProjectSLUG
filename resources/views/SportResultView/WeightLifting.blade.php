...
<div class="container">
	<div class="jumbotron" style="background: linear-gradient(to bottom left, #00ccff 23%, #cc33ff 100%);">
        <div class="heading-section ftco-animate">
	        <h2 class="mb-4 text-center">WeightLifting Game Reports</h2>
	    </div><br><br>
        <div class="d-flex justify-content-center">
            <form class="form-inline" action="/weight" method="post">
            {{ csrf_field() }}
                ...
                @if(isset($r))        
                    ...
                    <table class="table table-hover table-dark" align="center">
                                    <tr>
                                        ...
                                        <th class="text-center">WeightClass</th>
                        ...
                        @foreach($r as $item)                 
                                    <tr>
                                        ...
                                        <td style="text-align:center;" class=""><p>{{$item->WeightCategory}}</p></td>
                                        <td style="text-align:center;" class=""><p>{{round($item->Total)}}KG</p></td>
