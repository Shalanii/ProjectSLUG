...
<section class="blog"><br><br>
	...
	<div class="jumbotron" style="background: linear-gradient(to bottom left, #00ccff 23%, #cc33ff 100%);">
		...
		<span class="subheading">Athletics - SLUG-XIII</span>
	        <h2 class="mb-4 text-center">Running Game Reports</h2>
	    </div>
        <div class="d-flex justify-content-center">
            <form class="form-inline" action="/serachrunningresult" method="post">
            {{ csrf_field() }}
            ...
            <div class="form-group mr-2">        
                <select name="Round" class="form-control">
                       ...
                       @foreach($r3 as $data)
                            <option value="{{$data->Round}}">{{$data->Round}}</option>
                        @endforeach
                </select>
            </div>
		<div class="form-group mr-2">        
