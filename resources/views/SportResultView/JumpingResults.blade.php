...
<section class="blog"><br><br>
	...
	<div class="row justify-content-center">
		...
		<span class="subheading">Athletics - SLUG-XIII</span>
	        <h2 class="mb-4">Jumping Results Report</h2>
	    </div>
	</div>
        <div class="d-flex justify-content-center">
            <form class="form-inline" action="/serachjumpingresult" method="post">
            {{ csrf_field() }}
        ...
        <div class="row">
                ...
                @if(isset($r))        
					...
					<td style="text-align:center;" class=""><p>{{$item->PlayerName}}</p></td>
                                        ...
                                        <td style="text-align:center;" class=""><p>{{$item->Height_Distance}}m</p></td>
