...
<section class="blog"><br><br>
	...
	<div class="jumbotron" style="background: linear-gradient(to bottom left, #00ccff 23%, #cc33ff 100%);">
        <div class="heading-section ftco-animate">
	        <h2 class="mb-4 text-center">Chess Game Reports</h2>
	    </div>
        <div class="d-flex justify-content-center">
        <form class="form-inline" action="/search20" method="post">
        {{csrf_field()}}
...
<div class="container" align="center">
    ...
    @foreach($r as $item)
    <div class="col-md-6">
	    <div class="scoreboard scoreboard-2 slash" style="background:url(/img/mascot/che.jpg);background-size:cover;max-height:900px;max-width:900px;" data-stellar-background-ratio="0.5">
			<br><div class="divider ftco-animate text-center"><span style="color:#dae44d;font-size:16px;">{{$item->Date}} | Round - {{$item->Round}}</span></div>
				<div class="divider ftco-animate text-center mb-4"><span>Gender :- {{$item->Gender}}</span></div>
				        ...
				        <div class="d-sm-flex mb-4">
					        <div class="sport-team d-flex align-items-center">
								...
								<div class="text-center px-1 px-md-3 desc">
									<h3 class="score win"><span>{{round($item->Uni1_Score)}}</span></h3>
					        ...
					        <div class="sport-team d-flex align-items-center">
								...
								@endif
								<div class="text-center px-1 px-md-3 desc">
									<h3 class="score lost"><span>{{round($item->Uni2_Score)}}</span></h3>
