...
<section class="blog"><br><br>
	...
	<div class="jumbotron" style="background: linear-gradient(to bottom left, #00ccff 23%, #cc33ff 100%);">
        ...
        <form class="form-inline" action="/search10" method="post">
        {{csrf_field()}}
...
<div class="container" align="center">
    ...
    <div class="col-md-6">
	    <div class="scoreboard scoreboard-2 slash" style="background:url(/img/image/volleyball.jpg);background-size:cover;min-height:auto;" data-stellar-background-ratio="0.5">
			<br><div class="divider ftco-animate text-center"><span span style="color:#dae44d;font-size:16px;">{{$item->Date}} | Round - {{$item->Round}}</span></div>
				<div class="divider ftco-animate text-center mb-4"><span span class="x">{{$item->Gender}} | Group - {{$item->SportGroup}}</span></div>
			        ...
			        <div class="text-center ftco-animate">
                        ...
                        @endif
				          	<p class="mb-0"><a href="volleyballresult/{{$item->MatchNo}}" class="btn btn-primary">More Details</a></p>
				    </div>
			    </div>
	          	</div>
    @endforeach
