...
<div class="row justify-content-md-center">
    ...
    <div class="scoreboard scoreboard-2 slash">
        <h4 style="font-size:20px;"><center>Discus Throw(Men)</center></h4>
        <h4 style="font-size:20px;"><center>Final Result</center></h4>
        <hr class="my-8">
    ...
    <div class="col-md-6">
    <div class="scoreboard scoreboard-2 slash">
        <h4 style="font-size:20px;"><center>Discus Throw(Women)</center></h4>
        <h4 style="font-size:20px;"><center>Final Result</center></h4>
        <hr class="my-8">
            <div class="table-responsive">
            <table class="table table-hover table-dark">
...
<div class="row justify-content-md-center">
    <div class="col-md-6">
    <div class="scoreboard scoreboard-2 slash">
        <h4 style="color:black;font-size:20px;"><center>Javelin Throw(Men)</center></h4>
        <h4 style="color:black;font-size:20px;"><center>Final Result</center></h4>
        <hr class="my-8">
            <div class="table-responsive">
            <table class="table table-hover table-dark">
                <tr>
    ...
    <div class="col-md-6">
    <div class="scoreboard scoreboard-2 slash">
        <h4 style="color:black;font-size:20px;"><center>Javelin Throw(Women)</center></h4>
        <h4 style="color:black;font-size:20px;"><center>Final Result</center></h4>
        <hr class="my-8">
            <div class="table-responsive">
            <table class="table table-hover table-dark">
...
<div class="row justify-content-md-center">
    <div class="col-md-6">
    <div class="scoreboard scoreboard-2 slash">
        <h4 style="color:black;font-size:20px;"><center>Shot Put(Men)</center></h4>
        <h4 style="color:black;font-size:20px;"><center>Final Result</center></h4>
        <hr class="my-8">
            <div class="table-responsive">
            <table class="table table-hover table-dark">
    ...
    <div class="col-md-6">
    <div class="scoreboard scoreboard-2 slash">
        <h4 style="color:black;font-size:20px;"><center>Shot Put(Women)</center></h4>
        <h4 style="color:black;font-size:20px;"><center>Final Result</center></h4>
        <hr class="my-8">
            <div class="table responsive">
            <table class="table table-hover table-dark" style="background-color:black;">
                <tr>
                <th>Rank</th>
                <th>Name</th>
                <th>University</th>
